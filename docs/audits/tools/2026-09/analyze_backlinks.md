...
**Karar (kapanış, 2026-09-04):** **KISMEN DÜZELTİLDİ** (dilim 5 düzeltmesi, #227 · #229) — üç bulgu kapandı (AB-2 canlı ✔, AB-3, AB-5) ve AB-1'in çıktı-tavanı yarısı kapandı. **Kalan:** AB-1'in varsayılan `limit` yarısı İMZA; **AB-4 ve AB-6 AÇIK — iş emrine hiç girmedi.** Ölçüm turunun kararı yukarıda durur, silinmedi (ders 16).
