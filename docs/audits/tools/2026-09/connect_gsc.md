...
**Karar (kapanış, 2026-09-02):** KAPANDI (dilim 1 düzeltmesi, #203 + #206 [CI'da, merge bekliyor]) — iki P1 de kapandı: handler port'a ayrıldı ve hızlı şeritte kapıya bağlandı (CG-1), "bulunamadı" cümlesi ailenin tek sesine geçti (CG-2, canlı doğrulandı). **Kalan:** CG-3 (P2, açık — cümle yazılmadı), CG-4 (P2, canlıda ölçülemedi).
