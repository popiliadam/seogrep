...
**Karar (kapanış, 2026-09-04):** **KISMEN DÜZELTİLDİ** (dilim 5 düzeltmesi, #227 · #228 · #229; BD-8 için **#230 main'de, `800d5ee`**) — dört bulgu kapandı (BD-1 canlı ✔, BD-2, BD-3, BD-6, BD-7). **Kalan:** BD-4 ve BD-5 **AÇIK — iş emrine hiç girmedi**; **BD-8 yeni** ve #230 ile `main`'de; canlı doğrulaması henüz YOK. Ölçüm turunun kararı yukarıda durur, silinmedi (ders 16).
