...
**Karar (kapanış, 2026-09-02):** KAPANDI (dilim 1 düzeltmesi, #203 + #204 + #206 [CI'da, merge bekliyor]) — tek P1 (F-2, `audit_content_runs` basamağı / E-9 regresyon kilidi) hızlı şeritte pinlendi; ayrıca S7 gereği description artık "Costs 0 credits." diyor (#203). **Kalan:** F-1 **İMZA KALEMİ** (katalog kapsamı, operatörde) ve altı P2 (F-4, F-5, F-6, F-7, F-8, F-10; F-5 imza gerektiriyor).
