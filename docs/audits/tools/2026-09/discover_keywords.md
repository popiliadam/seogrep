...
**Karar (kapanış, 2026-09-04):** **DÜZELTME GEREKLİ — kalan: DK-1 (İMZA, tavan) ve DK-2'nin sıralama yarısı (İMZA).** Kapanan: DK-2'nin şerh yarısı + DK-3 (#224, hata yolunda rezervasyon) + DK-4 (#223). DK-1 bu turda İKİNCİ kez ölçüldü ve yine işlevsiz çıktı — bu kez `for_site`/en-2840'ta, canlıda. DK-5 → Dilim 5/6 · DK-6 AÇIK · DK-7 → kart dilimi. Ölçüm turunun kararı SİLİNMEDİ (ders 16).
