...
**Karar:** DÜZELTME GEREKLİ — davranışın dördü de (arşivle / idempotent / bulunamadı / geri gel) canlıda kusursuz, ama arşiv YAZMASINDAKİ kiracı filtresi hızlı şeritte tamamen görünmez ve o filtre, servis-rolü istemcisinde tek sınırdır.
