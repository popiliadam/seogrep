...
**Karar (kapanış, 2026-09-02):** KAPANDI (dilim 1 düzeltmesi, #198 + #203 + #204 + #206) — üç P1'in üçü de kapandı: idempotent untrack filtresi pinlendi (F-1), sweep kapsaması #198'de (F-2), okuma yolu `action:"list"` ile açıldı (F-3, canlı doğrulandı). **Kalan:** F-4, F-5, F-6, F-7, F-9 (beş P2 açık; F-9 imza gerektiriyor).
