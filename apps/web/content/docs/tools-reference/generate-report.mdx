...
- **Technical health** — the HTTP status split and the pages behind it, plus broken internal links, slow and heavy pages, redirect chains, `X-Robots-Tag` conflicts, deep and orphaned pages, skipped-page categories, and the sitemap-vs-crawl comparison.
