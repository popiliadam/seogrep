---
title: list_jobs
description: "List your recent background jobs — crawls and Search Console pulls — newest first, with each job_id. Use it when you do not have a job_id to hand. Pages…"
---
