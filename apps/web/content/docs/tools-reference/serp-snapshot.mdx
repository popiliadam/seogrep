...
This is the one part of the rank tracker that is gated. [`track_keywords`](/docs/tools-reference/track-keywords) and [`keyword_positions`](/docs/tools-reference/keyword-positions) are free and run on any account, because neither contacts a search engine.
