...
- **Organic SERPs by position** — that same count split across the #1, #2-3, #4-10 and #11-20 bands, so a domain with many shallow rankings is easy to tell from one with a few strong ones.
