---
title: pull_gsc_data
description: "Pull two windows of Google Search Console performance (current + previous period) for a connected project, so find_quick_wins / detect_cannibalization / analyze_content_decay can analyze it. Run connect_gsc first."
---
