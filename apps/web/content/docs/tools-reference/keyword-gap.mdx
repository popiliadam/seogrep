...
| `limit` | integer | No | How many gap keywords to return (1–1000, default 100), highest search volume first. The header always says how many gaps exist in total, so a shorter list never reads like the whole picture. |
