---
title: audit_tech
description: "Audit technical SEO for a project's latest crawl: HTTP status spread, redirects, skipped URLs by reason, and robots (noindex) conflicts. Run crawl_site first."
---
