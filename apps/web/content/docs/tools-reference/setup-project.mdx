---
title: setup_project
description: "Register a website domain to track. Accepts a domain or URL; returns the project id. Idempotent — calling it again for the same domain returns the existing project."
---
