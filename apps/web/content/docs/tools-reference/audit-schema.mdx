---
title: audit_schema
description: "Audit structured data (JSON-LD) for a project's latest crawl: coverage and the spread of schema.org @type names, plus pages with none. Run crawl_site first."
---
