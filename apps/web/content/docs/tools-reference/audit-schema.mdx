---
title: audit_schema
description: "Report JSON-LD COVERAGE across a project's latest crawl: which pages carry structured data, which carry none, and how often each schema.org @type name…"
---
