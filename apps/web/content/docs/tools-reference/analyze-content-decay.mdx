...
description: "Find decaying pages from your latest Search Console pull: pages whose clicks dropped meaningfully (absolute and proportional) vs the previous window, biggest loss first. Run pull_gsc_data first."
---
