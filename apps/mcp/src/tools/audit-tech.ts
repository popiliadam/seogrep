 ...
 *
 * THE FORMATTER PRINTS TWELVE SECTIONS AND THIS SENTENCE NAMED FOUR (measured 2026-08-26 on a
 ...
 * signal, the sitemap↔crawl diff, broken internal links — are the half added after the sentence
...
const DESCRIPTION =
  ...
  "Broken internal links, Sitemap vs crawl (printed whenever a sitemap was read — even at zero). " +
