// Kullanım: RESEND_API_KEY=... RESEND_SEGMENT_ID=... POSTHOG_API_KEY=... \
...
if (!email || !RESEND_API_KEY || !RESEND_SEGMENT_ID || !POSTHOG_API_KEY) {
  console.error("Eksik: e-posta argümanı + RESEND_API_KEY + RESEND_SEGMENT_ID + POSTHOG_API_KEY");
  process.exit(1);
}
